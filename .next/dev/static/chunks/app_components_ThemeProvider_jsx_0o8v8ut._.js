...
"[project]/app/components/ThemeProvider.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ThemeProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThemeProvider.useEffect": ()=>{
            const stored = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem("jpg-theme") : "TURBOPACK unreachable";
    ...
    const toggleTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ThemeProvider.useCallback[toggleTheme]": ()=>{
            setTheme({
                "ThemeProvider.useCallback[toggleTheme]": (t)=>t === "dark" ? "light" : "dark"
            }["ThemeProvider.useCallback[toggleTheme]"]);
        }
    }["ThemeProvider.useCallback[toggleTheme]"], []);
...
_s(ThemeProvider, "d7NTvFh64c295+tbiqdWdf9IILc=");
_c = ThemeProvider;
function useTheme() {
    _s1();
...
//# sourceMappingURL=app_components_ThemeProvider_jsx_0o8v8ut._.js.map