...
export default function Page() {
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-hidden">
      ...
      <footer className="hidden sm:block fixed bottom-4 left-1/2 z-20 -translate-x-1/2 whitespace-nowrap pt-3 font-sans text-[12px] font-medium uppercase tracking-[0.14em] text-[var(--ink)] opacity-50">
